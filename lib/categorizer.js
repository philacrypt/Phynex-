...
const RULES = [
    ...
    },
    {
        ...
        strong: [
            ...
            'ankara', 'sweater', 'clothing', 'clothes'
        ],
        supporting: ['outfit']
    },
    {
    ...
    },
    {
        category: 'Vehicles',
        strong: [
            'saloon car', 'sedan car', 'suv for sale', 'pickup truck', 'station wagon',
            'toyota probox', 'toyota axio', 'toyota vitz', 'nissan note', 'car for sale',
            'truck for sale', 'boda boda motorbike'
        ],
        supporting: ['logbook', 'mileage']
    },
    {
        category: 'Musical Instruments',
        strong: [
            'guitar', 'acoustic guitar', 'electric guitar', 'musical keyboard',
            'drum set', 'violin', 'saxophone', 'trumpet', 'piano', 'ukulele', 'dj mixer'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'solar panel', 'solar system kit', 'solar inverter', 'solar battery',
            'solar water heater', 'off-grid solar', 'solar street light', 'solar charge controller'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'fertilizer', 'pesticide', 'farm equipment', 'tractor', 'irrigation kit',
            'poultry feed', 'animal feed', 'greenhouse', 'incubator', 'dairy meal'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'cement', 'roofing sheet', 'roofing sheets', 'floor tiles', 'wall tiles',
            'timber', 'steel bar', 'construction material', 'gypsum ceiling', 'paint bucket'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'party decoration', 'party balloons', 'party tent', 'event tent',
            'wedding decor', 'birthday decoration', 'photo booth props'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'cctv', 'cctv camera', 'security camera', 'camera system', 'surveillance camera',
            'burglar alarm', 'fire extinguisher', 'motion sensor light',
            'safety helmet', 'padlock', 'safe box', 'security fence'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'led bulb', 'light bulb', 'ceiling light', 'electrical cable',
            'extension cable', 'socket outlet', 'circuit breaker', 'electrical wire'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'cookware set', 'cutlery set', 'dinner set', 'non-stick pan',
            'kitchen knife set', 'cooking pot', 'serving dish', 'chopping board'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'bedsheet', 'bed sheet', 'pillowcase', 'mosquito net',
            'towel set', 'fleece blanket', 'bed linen'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'wedding dress', 'bridal gown', 'wedding gown', 'bridesmaid dress', 'wedding suit'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'lingerie', 'underwear set', 'boxer shorts', 'sports bra', 'panties set'
        ],
        supporting: []
    },
    {
        ...
        strong: [
            'maternity', 'maternity dress', 'nursing bra', 'breast pump',
            'maternity wear', 'nursing cover', 'pregnancy pillow'
        ],
        supporting: []
    },
    {
        category: 'Digital Products & Gift Cards',
        strong: [
            'gift card', 'airtime voucher', 'software license', 'game credit',
            'subscription code', 'itunes card', 'google play gift card', 'steam wallet code'
        ],
        supporting: []
    }
];
